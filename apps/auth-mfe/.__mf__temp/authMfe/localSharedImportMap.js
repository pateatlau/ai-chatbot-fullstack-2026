    ...
    const importMap = {
      ...
      ,
        "react-router-dom": async () => {
          let pkg = await import("__mf__virtual/authMfe__prebuild__react_mf_2_router_mf_2_dom__prebuild__.js");
            return pkg;
        }
      ,
        "zod": async () => {
          let pkg = await import("__mf__virtual/authMfe__prebuild__zod__prebuild__.js");
            return pkg;
        }
      ,
        "zustand": async () => {
          let pkg = await import("__mf__virtual/authMfe__prebuild__zustand__prebuild__.js");
            return pkg;
        }
      ...
      const usedShared = {
        ...
        ,
          "zod": {
            ...
            async get () {
              if (false) {
                throw new Error(`Shared module '${"zod"}' must be provided by host`);
              }
